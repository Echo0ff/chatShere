...
from src.chatSphere.core.auth import auth_manager, oauth_manager, get_current_active_user
from src.chatSphere.core.models import User, OAuthProvider
from src.chatSphere.core.cache import cache_manager
from src.chatSphere.services.responses import ApiResponse, ResponseCode, ResponseMessage, HTTP_STATUS_MAP
...
async def register_user(
    ...
    try:
        ...
        # 缓存用户会话
        await cache_manager.cache_user_session(user.id, {
            "user_id": user.id,
...
async def oauth2_login(
    ...
    try:
        ...
        # 缓存用户会话
        await cache_manager.cache_user_session(result["user"]["id"], {
