...
class AuthManager:
    ...
    async def store_refresh_token(self, session: AsyncSession, user_id: str, token: str) -> RefreshToken:
        """存储刷新令牌"""
    ...
    async def refresh_access_token(self, session: AsyncSession, refresh_token: str) -> Dict[str, str]:
        """使用刷新令牌获取新的访问令牌"""
